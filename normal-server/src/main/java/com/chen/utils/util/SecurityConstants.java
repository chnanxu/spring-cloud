...
public class SecurityConstants {
     ...
     * 授权确认页面地址
     */
    public static final String DEVICE_ACTIVATED_URI = "http://lineben.cx.com/activated";

    /**
     * 授权确认页面地址
     */
    public static final String DEVICE_ACTIVATE_URI = "http://lineben.cx.com/activate";

    /**
     * 授权确认页面地址
     */
    public static final String CONSENT_PAGE_URI = "http://lineben.cx.com/consent";
